...
import CommonBrwoser from "~/components/common/Brwoser.vue";
...
const animateHeroText = () => {
  if (hero_text_anim.value) {
    ...
    if (heroTextAnimChildren.value.length > 0) {
      ...
      tl.to(heroTextAnimChildren.value, { y: "0px", duration: 1, opacity: 1, stagger: 0.3, delay: 0.5 });
    }
  }
};
...
<template>
  <div class="tp-hero-area tp-hero-pt pt-170 pb-70 p-relative">
    <div class="tp-hero-left-shape">
      <img src="~/assets/img/hero/hero-left-shape-3-1.png" alt="image-here" />
    </div>
    <div class="tp-hero-gradient-bg">
      <img src="~/assets/img/hero/hero-gradient-3.jpg" alt="image-here" />
    </div>
    <div class="container">
      <div class="row justify-content-center z-index-3">
        <div class="col-xl-11">
          <div class="tp-hero-title-box text-center">
            <h3
              ref="hero_text_anim"
              class="tp-hero-title-3 hero-text-anim pb-5"
            >
              <i><i ref="heroTextAnimChildren" class="child-1">Transforming<span> Ideas</span></i></i>
              <i><i ref="heroTextAnimChildren" class="child-1">Into Digital Success</i></i>
            </h3>
            <p class="tp-char-animation-2">
              Your cutting-edge IT solutions hub<br />
             We've got all your software development needs covered
            </p>
          </div>
          <div
            class="tp-hero-btn-3 text-center wow tpfadeUp"
          ...
          <div class="tp-hero-3-wrapper p-relative">
            ...
            <div class="tp-hero-3-main-thumb z-index-5">
              <img src="~/assets/img/hero/hero-img-3-1.png" alt="image-here" />
            </div>
            <div
              class="tp-hero-3-shape-5 d-none d-lg-block wow frist-img animated"
            >
              <img
                src="~/assets/img/hero/hero-img-3-1-3.png"
                alt="image-here"
              />
            </div>
