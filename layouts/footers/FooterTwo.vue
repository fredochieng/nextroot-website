...
<template>
  <footer>
    ...
    <div class="tp-footer__pl-pr grey-bg-2">
      <div class="tp-footer__area pt-90 tp-footer__tp-border-bottom">
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
              <div class="tp-footer__widget footer-widget-2 footer-col-2-1">
                <div class="tp-footer__logo mb-25">
                  <NuxtLink to="/">
                    <img src="~/assets/img/logo/logo-black.png" alt="image-here">
                  </NuxtLink>
                </div>
                <div class="tp-footer__contact-info">
                  <a href="https://www.google.com.bd/maps/place/%E0%A6%B2%E0%A6%BE%E0%A6%95%E0%A7%8D%E0%A6%B8%E0%A7%87%E0%A6%AE%E0%A6%AC%E0%A6%BE%E0%A6%B0%E0%A7%8D%E0%A6%97/@49.8143242,5.5590915,10z/data=!3m1!4b1!4m5!3m4!1s0x479545b9ca212147:0x64db60f602d392ef!8m2!3d49.815273!4d6.129583"
                    target="_blank" v-html="address"></a>
                  <ul>
                    <li>
                      <span>
                      ...
                      <a class="first-child" :href="`tel:${phone}`">{{ phone }}</a>
                    </li>
                    <li>
                      <span>
            ...
            <div v-for="(item, i) in footer_lisks" :key="i" class="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp"
              data-wow-duration=".9s" :data-wow-delay="item.delay">
              <div :class="`tp-footer__widget footer-widget-2 ${item.cls}`">
                <h4 class="tp-footer__widget-title">{{ item.title }}</h4>
                <div class="tp-footer__content">
                  <ul>
                    <li v-for="(link, index) in item.links" :key="index">
                      <NuxtLink :to="item.link">{{ link.name }}</NuxtLink>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="tp-footer__widget footer-widget-2 footer-col-2-4">
                ...
                <div class="tp-footer__download-box d-flex align-items-center">
                  <div class="tp-footer__qrcode mr-15">
                    <a href="#"> <img src="~/assets/img/footer/dwnld-1.png" alt="image-here"></a>
                  </div>
                  <div class="tp-footer__app">
                    <a href=""><img class="mb-15" src="~/assets/img/footer/dwnld-2.png" alt="image-here"></a>
                    <a href="#"><img src="~/assets/img/footer/dwnld-3.png" alt="image-here"></a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row align-items-center">
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
              <div class="tp-copyright__social">
                <NuxtLink v-for="(item, i) in social_links" :key="i" :to="item.link" target="_blank">
                  <i :class="item.icon"></i>
                </NuxtLink>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6">
              <div
                ...
                <div class="tp-copyright__lang tp-copyright__lang-2"> 
                  ...
                  <ul>
                    <li>
                      <a id="tp-copyright__lang-toggle" @click="hendleActive">
                        <span style="color: #1C274C">English (US)<i class="fal fa-angle-down"></i></span>
                      </a>
