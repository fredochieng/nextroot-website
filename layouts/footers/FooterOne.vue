      ...
      <div class="tp-footer__area pt-50">
        <div class="container">
          ...
          <div class="tp-footer__top-space">
            <div class="row">
              <div
                class="col-xl-4 col-lg-4 col-md-7 pb-30 wow tpfadeUp"
                data-wow-duration=".9s"
                data-wow-delay=".5s"
              >
                <div class="tp-footer__widget footer-col-1">
                  ...
                  <div class="tp-footer__text">
                    <p>
                      We bring your ideas to life by transforming your vision
                      into innovative, functional, and user-friendly software
                      solutions <br />
                    </p>
                  </div>
                  <div class="tp-footer__social">
                    ...
                    ></NuxtLink>
                    <NuxtLink target="_blank" to="https://www.vimeo.com"
              ...
              <div
                v-for="(item, i) in footer_lisks"
                :key="i"
                :class="`${item.cls_1} pb-30 wow tpfadeUp`"
                data-wow-duration=".9s"
                  ...
                  <div class="tp-footer__contact-info tp-footer__icon-space">
                    <ul>
                      ...
                      <li>
                        ...
                        <a href="mailto:info@nextroot.co.uk"
                          >info@nextroot.co.uk</a
                        >
                      </li>
                      <li>
                        <span>
                        ...
                        <a
                          href="https://maps.app.goo.gl/QxZG9yKZYoJHiUXZ8"
                          target="_blank"
                        >
                          2nd Floor,<br />
                          39 Ludgate Hill,<br />
          ...
          <div class="row align-items-center">
            ...
            >
              <div class="tp-copyright__text">
                <span
                  >Designed and developed by<a href="#"> Innovate Experts</a> -
