...
const { info, phone, email, footer_lisks, social_links } = footer_content
...
<template>
  <footer>
    ...
    <div :class="`tp-footer__pl-pr ${style_contact && 'pt-105'} ${bg_style ? 'grey-bg-2' : ''}`">
      <div :class="`tp-footer__area ${style_contact && 'p-relative'}  tp-footer__tp-border-bottom`">

        <template v-if="style_contact">
          <div class="tp-footer__shape-1 d-none d-xxl-block">
            <img :src="shape_img_1" alt="image-here">
          </div>
          <div class="tp-footer__shape-2 d-none d-xxl-block">
            <img :src="shape_img_2" alt="image-here">
          </div>
        </template>
        <div class="container">
          <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
              <div :class="`tp-footer__widget ${style_team && 'tp-footer__input-inner'} footer-widget-3 footer-col-3-1`">
            ...
            <div v-for="(item, i) in footer_lisks" :key="i" :class="`${item.cls_1} col-md-6 pb-30  wow tpfadeUp`"
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 pb-30  wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
              <div class="tp-footer__widget footer-widget-3 footer-widget-5 footer-col-3-4">
                ...
                <div class="tp-footer__social-3">
                  <h4>Social media</h4>
                  <NuxtLink 
                  v-for="(item,i) in social_links" :key="i"                  
                  :to="item.link" target="_blank"><i :class="item.icon"></i></NuxtLink>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
              <div class="tp-copyright__text tp-copyright__text-3 text-center">
                <span>Full Copyright & Design By
                  <NuxtLink target="_blank" to="https://themeforest.net/user/theme_pure/portfolio">
                    @Theme pure
                  </NuxtLink> - {{ new Date().getFullYear() }}
                </span>
              </div>
            </div>
          </div>
